...
// Joysticks
private final static XboxController xboxController = new XboxController(0);
...
// Create some buttons
    ...
    rightBumper.whenHeld(new ActivateLauncher() ,true);
        SmartDashboard.putData("Right Bumper",new ActivateLauncher() );
    ...
    leftStick.whileHeld(new DriveCommand() ,true);
    ...
    rightStick.whileHeld(new DriveCommand() ,true);
